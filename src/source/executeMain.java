...
public class executeMain {
	...
	System.out.println("Kevin's Grand parent is: "+query.getGradPa(Kevin).toString());
	System.out.println("People with no sibling's is: "+query.getpeopleWithNoSiblings(test).toString());
	System.out.println("People with no children is: "+query.getpeopleWithNoChildren(test).toString());	
    System.out.println("Peolpe with larger number of grand children is: "+query.MaxgrandChildList(test).toString());
